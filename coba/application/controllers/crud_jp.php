...
class Crud_jp extends CI_Controller
{
    ...
    function index()
    {
        ...
        $data['jenis_paket'] = $this->m_jenis_paket->tampil_data()->result();
        $this->load->view->admin('j_paket', $data);
    }

    function tambah()
    {
        //view yg dijadikan form untuk inputan data
        $this->load->view->admin('v_input_jp');
    }
    ...
    function hapus($id_jenis_paket)
    {
        ...
        $this->m_jenis_paket->hapus_data($where, 'jenis_paket');
        redirect('crud_jp/index');
    }
    ...
    function update()
    {
        ...
        $this->m_jenis_paket->update_data($where, $data, 'jenis_paket');
        redirect('crud_jp/index');
    }
}

<body>
    ...
    <center><?php echo anchor('crud_jp/tambah', 'Tambahkan'); ?></center>
        ...
        foreach ($jenis_paket as $u) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo anchor('crud_jp/edit/' . $u->id_jenis_paket, 'Edit'); ?>

                    <!-- tambahkan link hapus pada function code ignitor anchor, untuk menghapus data -->
                    <?php echo anchor('crud_jp/hapus/' . $u->id_jenis_paket, 'Del'); ?>
